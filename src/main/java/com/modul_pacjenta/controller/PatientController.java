...
//	@RequestMapping(value = "/addPatient", method = RequestMethod.GET)
    ...
    public String showPatientForm(RenderRequest request, RenderResponse response, Model model) {
        ...
        healthStatusList.put("Ciê¿ki", "Ciê¿ki");
...
//	@RequestMapping(value = "/addPatient", method = RequestMethod.POST)
    ...
    public String showPatientCard(RenderRequest request, RenderResponse response, Model model,
		...
		activityTypeList.put("Podanie leków (po³udnie)", "Podanie leków (po³udnie)");
		activityTypeList.put("Podanie leków (popo³udnie)", "Podanie leków (popo³udnie)");
		activityTypeList.put("Podanie leków (wieczór)", "Podanie leków (wieczór)");
		activityTypeList.put("Podanie posi³ku (Œniadanie)", "Podanie posi³ku (Œniadanie)");
		activityTypeList.put("Podanie posi³ku (obiad)", "Podanie posi³ku (obiad)");
		activityTypeList.put("Podanie posi³ku (kolacja)", "Podanie posi³ku (kolacja)");
